...
export const BudgetArchetypePageSkeleton: React.FC = () => (
  <div className="space-y-6 animate-pulse" aria-busy="true" aria-label="Loading network budget">
    ...
    <div className="bg-siloam-surface p-6 rounded-xl shadow-soft border border-siloam-border">
      <div className="h-6 w-56 bg-siloam-border rounded mb-4" />
